// Base path da subpasta (ex: /verify) — deriva da URL atual
const BASE_PATH = globalThis.location.pathname.replace(/\/+$/, '') || '';
const API_URL = `${globalThis.location.origin}${BASE_PATH}`;
